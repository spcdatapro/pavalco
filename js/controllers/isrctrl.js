(function(){
    ...
    isrctrl.controller('isrCtrl', ['$scope', '$filter', 'compraSrvc', 'authSrvc', 'empresaSrvc', 'DTOptionsBuilder', 'toaster', '$uibModal', function($scope, $filter, compraSrvc, authSrvc, empresaSrvc, DTOptionsBuilder, toaster, $uibModal){

        $scope.compras = [];
        $scope.compra = {};
        $scope.dectc = 2;
        $scope.params = {idempresa: 0, fdel: moment().startOf('month').toDate(), fal: moment().endOf('month').toDate(), cuales: '0'};
        $scope.sumaisr = 0.00;
