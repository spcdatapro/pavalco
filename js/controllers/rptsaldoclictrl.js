(function(){
    ...
    rptsaldoclictrl.controller('rptSaldoClientesCtrl', ['$scope', 'rptSaldoClientesSrvc', 'authSrvc', 'jsReportSrvc', '$sce', function($scope, rptSaldoClientesSrvc, authSrvc, jsReportSrvc, $sce){
