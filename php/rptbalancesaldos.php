...
//$app->get('/rptbalsal', function(){ echo 'aquí estoy'; });
...
$app->post('/rptbalsal', function(){
    ...
    try{
        ...
        $db->doQuery("INSERT INTO rptbalancesaldos(idcuentac, codigo, nombrecta, tipocuenta) SELECT id, codigo, nombrecta, tipocuenta FROM cuentac ORDER BY codigo");
