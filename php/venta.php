...
$app->get('/lstventas/:idempresa', function($idempresa){
    ...
    $query.= "CONCAT('GCF', LPAD(b.idcliente, 4, '0'), '-', LPAD(b.correlativo, 4, '0')) AS nocontrato, a.idcontrato, a.anulada, a.idrazonanulafactura, a.fechaanula, i.razon ";
    ...
    $query.= "INNER JOIN cliente h ON h.id = a.idcliente LEFT JOIN razonanulacion i ON i.id = a.idrazonanulafactura ";
